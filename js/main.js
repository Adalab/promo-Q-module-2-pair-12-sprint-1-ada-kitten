...
const kittenDescTwo = `Ruiseño, juguetón, le guta estar tranquilo y que nadie le
moleste. Es una maravilla acariciarle!`;
...
const kittenDescThree = `Ruiseño, juguetón, le guta estar tranquilo y que nadie le
moleste. Es una maravilla acariciarle!`;
